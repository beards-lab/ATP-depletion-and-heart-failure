...
% params.k_pas*max(SL-LSE - Lsc0, 0)^params.gamma; 
params0.mods = {'k_pas', 'gamma', 'mu', 'kSE_M', 'eta_M', 'Lsc0', 'ekSE'};
params0.mods = {'k_pas', 'gamma', 'mu', 'kSE_M', 'Lsc0', 'ekSE'};
...
options = optimset('Display', 'iter', 'TolFun', 1e-4, 'TolX', 1e-3, 'MaxIter', 100, 'PlotFcns',@optimplotfval, 'MaxFunEvals', 1000);
...
clf;
params0.PlotEachSeparately = 1;
params0.RunSlackSegments = 'AllPassive';
params0.RunForceLengthEstim = false;
% params0.FitPassivePeaksMultiplier = 2;
...
% writeParamsToMFile('params/ModelParamsWPassive_NewOpt2', params0, [])

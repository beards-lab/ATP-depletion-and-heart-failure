...
'PieceWiseStrainDep2X__6'       ,
'PieceWiseStrainDepR21Params__1',
'PieceWiseStrainDepX__1'        ,
'kstiff1_n'                     ,
'PieceWiseStrainDepR21X__4'     ,
'slope'                         ,
'k_1'                           }
...
% params0.FV_velocities = -[0.5 1 2 3 4];
...
% Experiment with bound params
params0.mu = "=mu_neg";
params0.kstiff1 = "=kstiff2";
params0.kstiff1_n = "=kstiff2_n";
p = getParams(params0)
% %%
% clf;
%% params0.UseMaxwellDashpot = false;
...
params0.PlotEachSeparately = true;
params0.FV_velocities = -[0.5 1 2 3];
params0.RunSlackSegments = 'AllPar';
RunBakersExp;
...
paramNames = { ...
    ...
    'kamh', ...
    'ksrd2sr', ...
    'PieceWiseStrainDep2X__1', ...
    'PieceWiseStrainDep2X__5', ...
    'PieceWiseStrainDep2X__6', ...
    'PieceWiseStrainDep2X__7', ...
    'PieceWiseStrainDep2Params__1', ...
    'PieceWiseStrainDep2Params__5', ...
    'PieceWiseStrainDep2Params__6', ...
    'PieceWiseStrainDep2Params__7', ...
    'PieceWiseStrainDepR1DX__1', ...
    'PieceWiseStrainDepR1DX__4', ...
    'PieceWiseStrainDepR1DParams__1', ...
    'PieceWiseStrainDepR1DParams__4', ...
    'PieceWiseStrainDepR21X__1', ...
    'PieceWiseStrainDepR21X__4', ...
    'PieceWiseStrainDepR21Params__1', ...
    'PieceWiseStrainDepR21Params__4', ...
    'k2d', ...
    'drmr', ...
    'mu_neg', ...
    'kstiff2_n', ...
...
% for i_param = selectedParamsForResim
    try
        fprintf('Running %g/%g) %s..', i_param, length(paramNames), paramNames{i_param});
...
toc
%% 
dfeatureMatrixPlus = featureMatrixPlus(2:end, :) - featureMatrixPlus(1, :);
head(sum(featureMatrixPlus, 2))
sum(featureMatrixPlus, 2);
head(sum(dfeatureMatrixPlus, 2));
clf;
bar(sum(dfeatureMatrixPlus, 2))
[val, parpos] = sort(abs(sum(dfeatureMatrixPlus, 2)), 'descend')

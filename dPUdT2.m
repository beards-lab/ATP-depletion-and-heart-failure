function f = dPUdT2(~,PU,N,dS,MgATP,Pi,MgADP,g,SL)
% ODE function for the d/dt operator for the cross-bridge mode. With ksr0
...
% K_T2 = 0.025; % (mM) ATP binding to P state
K_T3 = g(15)*2.5; % (mM)

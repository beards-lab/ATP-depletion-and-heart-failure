...
sd = @(kx, alphaL, alphaR, dr) min(1e4, kx*(exp(alphaL*(s-dr).^2).*(s<dr) + exp(alphaR*(s-dr).^2).*(s>dr)));
...
R1D = p1.*sd(params.kd, params.alpha0, params.alpha0, params.dr0);

R12 = p1.*sd(params.k1, params.alpha1, 0, params.dr1); % P1 to P2
R21 = f1*p2.*sd(params.k_1, params.alpha_1, params.alpha_1, params.dr_1); % p2 to p1

R2T = p2.*sd(params.k2, params.alpha2_L, params.alpha2_R, params.dr2);

function cost = fitSlackForceOnset(datatable, velocitytable,t, SL, Force, plotData)
...
[dSLpc, ktr, df, del, E, SL, x0lin]  = fitRecovery(modeldatatable, zones, 0, [], plotData);
...
% [~, ~, ~, ~, ~, SL_d, x0lin_d]  = fitRecovery(datatable, zones_d, 0, [], plotData);
